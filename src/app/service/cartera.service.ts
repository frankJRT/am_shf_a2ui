...
export class CarteraService {
  ...
  public periodos():Observable<Periodo[]>{
    return this.httpClient.get<Periodo[]>(this.carteraUrl+'periodos',cabecera);
  }

  public listArchivosCorreo(cartera:number,periodo:number):Observable<ArchivoCorreo[]>{
    let params = new HttpParams().set('cartera',cartera).set('periodo',periodo);
  ...
  public listaDolar():Observable<CatDolar[]>{
    return this.httpClient.get<CatDolar[]>(this.carteraUrl+'dolares',cabecera);
  }

  public saveUid(dia:number, mes:number, anio:number,valor:number){
    let params = new HttpParams().set("dia",dia)
      .set("mes",mes).set("anio",anio).set("valor",valor);
      return this.httpClient.get(this.carteraUrl+'udis/addUdi',{params:params,responseType: 'text'});
  }

  public saveUma(dia:number, mes:number, anio:number,valor:number){
    let params = new HttpParams().set("dia",dia)
      .set("mes",mes).set("anio",anio).set("valor",valor);
      return this.httpClient.get(this.carteraUrl+'umas/addUmas', {params:params,responseType: 'text'});
  }

  public saveDolar(dia:number, mes:number, anio:number,valor:number){
    let params = new HttpParams().set("dia",dia)
      .set("mes",mes).set("anio",anio).set("valor",valor);
      return this.httpClient.get(this.carteraUrl+'dolares/addDolar', {params:params,responseType: 'text'});
  }
  
  public deleteUdi(id:number){
    return this.httpClient.delete(this.carteraUrl+'udis/'+id, {responseType: 'text'});
  }
  public deleteUma(id:number){
    return this.httpClient.delete(this.carteraUrl+'umas/'+id, {responseType: 'text'});
  }
  public deleteDolar(id:number){
    return this.httpClient.delete(this.carteraUrl+'dolares/'+id, {responseType: 'text'});
  }
}
