...
export class ComportamientoService {
  ...
  public listFilesbyCartera(
    periodoProceso: number
  ): Observable<ControlEnvio[]> {
    let params = new HttpParams().set('id', periodoProceso);
    return this.httpClient.get<ControlEnvio[]>(
      this.comportamientoUrl + 'listFiles',
      {
        params: params,
        headers: new HttpHeaders({ 'Content-Type': 'application/json' }),
      }
  ...
  public staticsFile(fileid: number): Observable<ControlEnvioStatic[]> {
    ...
    return this.httpClient.get<ControlEnvioStatic[]>(
      this.comportamientoUrl + 'staticsFile',
      {
        params: params,
        headers: new HttpHeaders({ 'Content-Type': 'application/json' }),
      }
  ...
  public deleteFile(id: number) {
    return this.httpClient.delete(this.comportamientoUrl + 'deleteFile/' + id, {
      responseType: 'text',
    });
  }
  ...
  public uploadProdData(id: number) {
    return this.httpClient.get(
      this.comportamientoUrl + 'spInsertDataPeriodoProceso/' + id,
      { responseType: 'text' }
    );
  }
  ...
  public generaV9(idCartera: number, idPeriodo: string) {
    ...
    return this.httpClient.get(
      this.comportamientoV9Url + 'generaComportamientoV9',
      {
        params: params,
        headers: new HttpHeaders({ 'Content-Type': 'application/json' }),
        responseType: 'blob',
  ...
  public generaProcessPython(
    ...
    let params = new HttpParams()
      ...
      .set('id', idCartera)
      .set('idPeriodo', idPeriodo);
    return this.httpClient.get(this.comportamientoUrl + 'procesoPython', {
      params: params,
      headers: new HttpHeaders({ 'Content-Type': 'application/json' }),
      responseType: 'blob',
    });
